...
.lwf-button-wrapper [type="button"]:not(:disabled),.lwf-button-wrapper [type="reset"]:not(:disabled),.lwf-button-wrapper [type="submit"]:not(:disabled),.lwf-button-wrapper button:not(:disabled) {
	cursor: not-allowed;
}
...
.lwf-process-btn.lwf-completed {
   ...
   .lwf-process-btn.lwf-completed::after {
    ...
    /* Progress line between buttons */
.lwf-button-wrapper {
  position: relative;
}

.lwf-button-wrapper::after {
    content: "";
    position: absolute;
    top: 50%;
    ...
    transform: translateY(-50%);
   height: 2px;
    width: 40px;  /* same as gap value */
    background: #d8d6d6;
    z-index: 1;
    border: 1px dashed aliceblue;
}

.lwf-button-wrapper:last-child::after {
    display: none;
}
/* Progress line completed */
.lwf-button-wrapper.completed::after {
  background: #3B82F6;
}
...
.CustomerApprovalTab.DisburesmentTab .tab-header {
	display: flex;
	overflow-x: auto;
	border-top: none;
	border-bottom: none;
                                         ...
                                         <div class="lwf-buttons-grid">
                                                            ...
                                                            <div class="lwf-button-wrapper">
                                                                <button 
                                                                    ...
                                                                    <iconify-icon icon="hugeicons:note-02" class="lwf-btn-icon"></iconify-icon>
                                                            ...
                                                            <div class="lwf-button-wrapper">
                                                                <button 
                                                                    ...
                                                                    <iconify-icon icon="iconoir:bank" class="lwf-btn-icon"></iconify-icon>
                                                            ...
                                                            <div class="lwf-button-wrapper">
                                                                <button 
                                                                    ...
                                                                    <iconify-icon icon="hugeicons:money-02" class="lwf-btn-icon"></iconify-icon>
                                                            ...
                                                            <div class="lwf-button-wrapper">
                                                                <button 
                                                                    ...
                                                                    <iconify-icon icon="solar:calendar-linear" class="lwf-btn-icon"></iconify-icon>
...
<div class="modal fade modernModalWrapper ModernWraper-style2" id="lwfLoanAgreementModal" tabindex="-1" aria-labelledby="lwfLoanAgreementModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="ModalHead modal-header lwf-modal-header">
        <h5 class="modal-title lwf-modal-title" id="lwfLoanAgreementModalLabel">
          <iconify-icon icon="fluent:warning-28-regular"></iconify-icon> Confirm Loan Agreement
        </h5>
       <button type="button" class="btnClose btn btn-sm btn-bg-transparent" data-bs-dismiss="modal">
            <iconify-icon icon="oui:cross"></iconify-icon>
          </button>
      ...
      <div class="modal-body lwf-modal-body">
        ...
        <h4 class="">Are you sure you want to initiate the Loan Agreement process?</h4>
        <p class="lwf-modal-subtext">This will start the loan agreement procedure and update the status to "In Progress".</p>
        <div class="FooterActionStyle2 FooterActionStyle1">
        <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-theme" id="lwfConfirmLoanAgreement">Confirm</button>
      </div>
        </div>
...
<!-- Enash Modal -->
<div class="modal fade modernModalWrapper ModernWraper-style2" id="lwfEnashModal" tabindex="-1" aria-labelledby="lwfEnashModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="ModalHead modal-header lwf-modal-header">
        <h5 class="modal-title lwf-modal-title" id="lwfEnashModalLabel">
          <iconify-icon icon="fluent:warning-28-regular"></iconify-icon> Confirm Enash Process
        </h5>
       <button type="button" class="btnClose btn btn-sm btn-bg-transparent" data-bs-dismiss="modal">
            <iconify-icon icon="oui:cross"></iconify-icon>
          </button>
      ...
      <div class="modal-body lwf-modal-body">
        ...
        <h4 class="">Are you sure you want to initiate the Enash process?</h4>
        ...
        <button type="button" class="btn btn-theme" id="lwfConfirmEnash">Confirm</button>
      </div>
        </div>
...
<!-- Penny Drop Modal -->
<div class="modal fade modernModalWrapper ModernWraper-style2" id="lwfPennyDropModal" tabindex="-1" aria-labelledby="lwfPennyDropModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="ModalHead modal-header lwf-modal-header">
        <h5 class="modal-title lwf-modal-title" id="lwfPennyDropModalLabel">
          <iconify-icon icon="fluent:warning-28-regular"></iconify-icon> Confirm Penny Drop
        </h5>
       <button type="button" class="btnClose btn btn-sm btn-bg-transparent" data-bs-dismiss="modal">
            <iconify-icon icon="oui:cross"></iconify-icon>
          </button>
      ...
      <div class="modal-body lwf-modal-body">
        ...
        <h4 class="">Are you sure you want to initiate the Penny Drop verification?</h4>
        <p class="lwf-modal-subtext">This will start the bank account verification and update the status to "In Progress".</p>
        <div class="FooterActionStyle2 mt-4">
        <button type="button" class="btn btn-secondary lwf-cancel-btn" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-theme" id="lwfConfirmPennyDrop">Confirm</button>
      </div>
        </div>
...
<div class="modal fade modernModalWrapper ModernWraper-style2" id="lwfScheduleDisbursementModal" tabindex="-1" aria-labelledby="lwfScheduleDisbursementModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header lwf-modal-header">
        <h5 class="modal-title lwf-modal-title" id="lwfScheduleDisbursementModalLabel">
          <iconify-icon icon="fluent:warning-28-regular"></iconify-icon> Confirm Schedule Disbursement
        </h5>
       <button type="button" class="btnClose btn btn-sm btn-bg-transparent" data-bs-dismiss="modal">
            <iconify-icon icon="oui:cross"></iconify-icon>
          </button>
      ...
      <div class="modal-body lwf-modal-body">
        ...
        <h4 class="">Are you sure you want to schedule the loan disbursement?</h4>
        <p class="lwf-modal-subtext">This will start the disbursement scheduling and update the status to "In Progress".</p>
        <div class="FooterActionStyle2 mt-4">
        <button type="button" class="btn btn-secondary lwf-cancel-btn" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-theme" id="lwfConfirmScheduleDisbursement">Confirm</button>
      </div>
        </div>
...
function setButtonCompleted(step) {
    if (buttons[step]) {
        ...
        // Mark wrapper as completed (for progress line)
        buttons[step].parentElement.classList.add('completed');
