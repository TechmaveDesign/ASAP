                            ...
                            <div class="CustomerApprovalTab">
                                ...
                                <div class="tab-header">
                                    ...
                                    <!-- <div class="subtext"><div class="status">Rejected</div> </div> -->
                                     ...
                                     <div class="tab" data-tab="panel7">
                                        <div class="step-title">Re-Apply Loan Details</div>
                                    <!-- <div class="subtext"><div class="status">Rejected</div> </div> -->
                                    </div>
                                </div>
                                     ...
                                     <div class="TabInnerHead">
                                                ...
                                                <div class="CustomCard">
                                                    ...
                                                    <div class="ReportData_fields BussinessRepport">
                                                        ...
                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Applicant Full Name</div>
                                                        <div class="userenuData">Ms. Riya Kapoor</div>
                                                        </div>

                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Date of Birth</div>
                                                        <div class="userenuData">18 July 1999</div>
                                                        </div>

                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Mobile Number</div>
                                                        <div class="userenuData">9860627992</div>
                                                        </div>

                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Email Address</div>
                                                        <div class="userenuData">ankursax95@gmail.com</div>
                                                        </div>
                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">PAN Number</div>
                                                        <div class="userenuData">MGYPK3409</div>
                                                        </div>
                                                          <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Loan Type </div>
                                                        <div class="userenuData">Personal Loan</div>
                                                        </div>
                                                        <div class="cu-task-fields__row">
                                                        <div class="cu-task-label-icon__container">Loan Amount Required (INR)</div>
                                                        <div class="userenuData">₹12,50,000</div>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="docCardWrapper BusinessDocument">
                                                        ...
                                                        <div class="docCard">
                                                            ...
                                                            <div class="docContent">
                                                                <span class="verified-badge">Verified</span>
                                                                <h6 class="doc-title"> Salary Slip Aug</h6>
                                                                <p class="step-label">Uploaded on</p>
                                                                <p class="doc-meta">14 July 2025, 3:42 PM</p>
                                                        ...
                                                        <div class="docCard">
                                                            ...
                                                            <div class="docContent">
                                                                <span class="verified-badge">Verified</span>
                                                                <h6 class="doc-title"> Salary Slip Sep</h6>
                                                                <p class="step-label">Uploaded on</p>
                                                                <p class="doc-meta">14 July 2025, 3:42 PM</p>
