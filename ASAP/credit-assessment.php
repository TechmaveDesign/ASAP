                                ...
                                <div id="tablefiltesa_container">
                                                        ...
                                                        <div class="col-lg-3 col-sm-6 col-12">
                                                            <div class="input-blocks">
                                                                ...
                                                                <select class="select2">
                                                                    ...
                                                                    <option>Pending for Assessment</option>
                                                                    <option>Customer Consent Sent</option>
									...
									<table class="table common-datatable nowrap w-100">
										...
										<tbody>
											<tr>
                                                <td>
                                                    <a href="credit-assessment-view.php" class="customerID">VASAP202500001</a>
                                                </td>
												...
												<td>98765 43210</td>
												<td><span class="badge badge-soft-warning my-1 me-2">Pending for Assessment</span></td>
												...
												<td>
													<div class="d-flex align-items-center">
														<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
															...
															href="credit-assessment-view.php">
											...
											<tr>
                                                <td>
                                                    <a href="credit-assessment-view.php" class="customerID">VASAP202500002</a>
                                                </td>
												...
												<td>98230 11456</td>
												<td><span class="badge badge-soft-primary my-1 me-2">Customer Consent Sent</span></td>
											...
											<tr>
                                                <td>
                                                    <a href="credit-assessment-view.php" class="customerID">VASAP202500003</a>
                                                </td>
											...
											<tr>
                                                <td>
                                                    <a href="credit-assessment-view.php" class="customerID">VASAP202500004</a>
                                                </td>
											...
											<tr>
                                                <td>
                                                    <a href="credit-assessment-view.php" class="customerID">VASAP202500005</a>
                                                </td>
