                                ...
                                <div id="tablefiltesa_container">
									...
									<table class="table common-datatable nowrap w-100">
										...
										<tbody>
                                            <tr>
                                                <td>
                                                    <a href="re-apply-loan-details.php" class="customerID">VASAP202500001</a>
                                                </td>
                                                ...
                                                <td>98765 43210</td>
                                                <td><span class="badge badge-soft-success my-1 me-2">Re-Apply Customer</span></td>
                                                <td>20/07/2025 10:15 AM</td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                                            data-bs-toggle="tooltip" title="View Customer Details"
                                                            href="re-apply-loan-details.php">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="re-apply-loan-details.php" class="customerID">VASAP202500002</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="re-apply-loan-details.php" class="customerID">VASAP202500003</a>
                                                </td>
