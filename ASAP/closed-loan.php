                                ...
                                <div id="tablefiltesa_container">
                                                        ...
                                                        <!-- <div class="col-lg-3 col-sm-6 col-12">
                                                            <div class="input-blocks">
                                                                ...
                                                                <select class="select2">
                                                                    ...
                                                                    <option>Approved & Scheduled Disbursement</option>
                                                                    <option>Pending For Disbursement</option>
									...
									<table class="table common-datatable nowrap w-100">
										...
										<tbody>
											<tr>
                                                <td>
                                                    <a href="disbursed-loan-view.php" class="customerID">VASAP202500001</a>
                                                </td>
                                                ...
                                                <td>SolarBiz Loan</td>
                                                <td>25/07/2025</td>
												<td><span class="badge badge-soft-success my-1 me-2">Closed</span></td>
												<td>
													<div class="d-flex align-items-center">
														<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
															data-bs-toggle="tooltip" title="View Customer Details"
															href="disbursed-loan-view.php">
															<span class="icon"><iconify-icon icon="proicons:eye"></iconify-icon></span>
														</a>
                                                        <a href="#" class="NOCbtn" data-bs-toggle="tooltip" title="Download NOC"> NOC</a>
													</div>
												</td>
											</tr>
											...
											<tr>
                                                <td>
                                                    <a href="disbursed-loan-view.php" class="customerID">VASAP202500002</a>
                                                </td>
											...
											<tr>
                                                <td>
                                                    <a href="disbursed-loan-view.php" class="customerID">VASAP202500003</a>
                                                </td>
											...
											<tr>
                                                <td>
                                                    <a href="disbursed-loan-view.php" class="customerID">VASAP202500004</a>
                                                </td>
											...
											<tr>
                                                <td>
                                                    <a href="disbursed-loan-view.php" class="customerID">VASAP202500005</a>
                                                </td>
